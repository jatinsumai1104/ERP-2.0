    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <a href="<?echo BASEPAGES?>manage-Supplier.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list-ul fa-sm text-white-75"></i> Manage Supplier </a>
        </div>
              ...
              <div class="card-body">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="">GST Number</label>
                    <input type="text"
                      class="form-control" name="gst_no" id="" aria-describedby="helpId" placeholder="">
                  </div>
                  <div class="form-group">
                    <label for="">Phone Number</label>
                    <input type="text"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label for="">Email</label>
                      <input type="text"
                        class="form-control" name="email_id" id="" aria-describedby="helpId" placeholder="">
                    </div>
                    <div class="form-group">
                      <label for="">Company Name</label>
                      <input type="text"
